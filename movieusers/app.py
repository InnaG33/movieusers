...
movies = pd.read_csv("/Users/grinn/Desktop/movieusers/movieusers/movies_urls.csv", low_memory=False, encoding = 'latin-1')
ratings = pd.read_csv("/Users/grinn/Desktop/movieusers/movieusers/ratings_short_vi.csv", low_memory=False, encoding = 'latin-1')
...
def main():
    ...
    if flask.request.method == 'GET':
        return(flask.render_template('indexusers.html', message=message))
...
#                print(f"Found reccomendations for user {user}: {recc_list}")
            ...
            return flask.render_template('positiveusers.html',list=movies_list,genres=genres,urls=urls,found=num,search_user=user-us_start, score=score)
...
# @app.route("/users")
# def users():
#     # export FLASK_APP=appusers.py
#     export FLASK_APP=appusers.py
#     return("/ridirect/flask run --host 0.0.0.0 --port 5001")
