...
movies = pd.read_csv("/Users/grinn/Desktop/movieusers/movieusers/output/movies_urls.csv", low_memory=False, encoding = 'latin-1')
ratings = pd.read_csv("/Users/grinn/Desktop/movieusers/movieusers/output/ratings_short_vi.csv", low_memory=False, encoding = 'latin-1')
